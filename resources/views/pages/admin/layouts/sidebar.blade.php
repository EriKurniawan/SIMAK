<aside class="main-sidebar edit-sidebar elevation-4">
    <!-- Brand Logo -->
    <a href="/" class="brand-link">
        <img src="/assets/img/SIMAK-01.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
